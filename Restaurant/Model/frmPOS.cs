    ...
    public partial class frmPOS : Form
    {
        ...
        private void btnDelivery_Click(object sender, EventArgs e)
        {
            ...
            if (frm.txtName.Text != "") // as take away did not have driver info
            {
                ...
                lblDriverName.Text = "Costomer Name: " + frm.txtName.Text + " Phone: " + frm.txtPhone.Text + " Driver: " + frm.cbDriver.Text;
        ...
        private void btnTake_Click(object sender, EventArgs e)
        {
            ...
            {
                driverID = frm.driverID;
                lblDriverName.Text = "Costomer Name: "+frm.txtName.Text+" Phone: "+frm.txtPhone.Text;
                lblDriverName.Visible = true;
                customerName = frm.txtName.Text;
                customerPhone = frm.txtPhone.Text;
            }
        ...
        private void btnKot_Click(object sender, EventArgs e)
        {
            ...
            // Create tables
            // need to add field table to store additional info
        ...
        private void btnHold_Click(object sender, EventArgs e)
        {
            ...
            if (OrderType=="")
            {
                guna2MessageDialog1.Show("Plaese select order type");
                return;
            }
